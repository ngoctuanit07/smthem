...
class Sm_Tablisting_Block_List extends Mage_Catalog_Block_Product_Abstract
{
	...
	public function getProducts($cat_id ){
		...
		if( $params != null ){
			...
			$is_ajax = isset($params['is_ajax'])?$params['is_ajax']:'';
			//$cat_id = $params['tab_cat_id'];
			$cat_id = isset($params['tab_cat_id'])?$params['tab_cat_id']:'';
			//$cat_config = $params['config_categoryid'];
			$cat_config = isset($params['config_categoryid'])?$params['config_categoryid']:'';
		}
